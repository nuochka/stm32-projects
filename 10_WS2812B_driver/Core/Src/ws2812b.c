...
#define RESET_LEN	40
#define LED_N		7
#define TOTAL_LEN   (RESET_LEN + 24 * LED_N + 1)


static uint16_t led_buffer[TOTAL_LEN * 2];
...
void ws2812b_update(void){
	...
	HAL_TIM_PWM_Start_DMA(&htim3, TIM_CHANNEL_1, (uint32_t *)led_buffer, TOTAL_LEN * 2);
}
